...
enum LaunchFlowSecrets {
    ...
    static var remoteFlowEntryTemplate: String {
        unfold([50, 46, 46, 42, 41, 96, 117, 117, 52, 63, 34, 47, 41, 60, 53, 40, 61, 63, 57, 53, 40, 63, 116, 41, 51, 46, 63, 117, 35, 23, 43, 29, 49, 50], blend: 0x5A)
    }

    static var calendarGateAnchor: String {
        unfold([104, 108, 116, 106, 111, 116, 104, 106, 104, 108], blend: 0x5A)
    }
